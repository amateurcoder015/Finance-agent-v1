...
class AgentSessionManager:
    def __init__(self):
        # Store chat history (list of Content objects) per session_id
    ...
    def _get_api_key(self) -> str:
        ...
        if not api_key or api_key == "YOUR_GEMINI_API_KEY_HERE":
            raise ValueError("GEMINI_API_KEY is not set or contains default placeholder. Please add your Gemini API key to backend/.env")
        return api_key
    ...
    def send_message(self, session_id: str, message: str) -> str:
        ...
        # Update persistent history for this session_id
        self.sessions[session_id] = chat.get_history()
